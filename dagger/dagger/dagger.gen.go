...
// The `ResultID` scalar type represents an identifier for an object of type Result.
...
func (r *Proxy) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadProxyFromID(ProxyID(id))
	return nil
}
...
// Load a Result from its ID.
func (r *Client) LoadResultFromID(id ResultID) *Result {
	q := r.Query.Select("loadResultFromID")
	q = q.Arg("id", id)
...
// Load a Vote from its ID.
func (r *Client) LoadVoteFromID(id VoteID) *Vote {
	q := r.Query.Select("loadVoteFromID")
	q = q.Arg("id", id)
...
func (r *Result) ID(ctx context.Context) (ResultID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response ResultID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Result) XXX_GraphQLType() string {
	return "Result"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Result) XXX_GraphQLIDType() string {
	return "ResultID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Result) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Result) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadResultFromID(ResultID(id))
	return nil
}

// ResultRunOpts contains options for Result.Run
type ResultRunOpts struct {
	ComponentsPath *Directory

	PostgresSvc *Service
}

func (r *Result) Run(dir *Directory, opts ...ResultRunOpts) *Service {
	assertNotNil("dir", dir)
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `postgresSvc` optional argument
		if !querybuilder.IsZeroValue(opts[i].PostgresSvc) {
			q = q.Arg("postgresSvc", opts[i].PostgresSvc)
		}
	}
	q = q.Arg("dir", dir)
...
// A unique identifier for this Vote.
func (r *Vote) ID(ctx context.Context) (VoteID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Vote) XXX_GraphQLType() string {
	return "Vote"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Vote) XXX_GraphQLIDType() string {
	return "VoteID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Vote) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Vote) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadVoteFromID(VoteID(id))
	return nil
}

// VoteRunOpts contains options for Vote.Run
type VoteRunOpts struct {
	Redis *Service

	ComponentsDir *Directory
}

func (r *Vote) Run(dir *Directory, opts ...VoteRunOpts) *Service {
	assertNotNil("dir", dir)
	q := r.Query.Select("run")
	for i := len(opts) - 1; i >= 0; i-- {
		// `redis` optional argument
		if !querybuilder.IsZeroValue(opts[i].Redis) {
			q = q.Arg("redis", opts[i].Redis)
		}
		// `componentsDir` optional argument
		if !querybuilder.IsZeroValue(opts[i].ComponentsDir) {
			q = q.Arg("componentsDir", opts[i].ComponentsDir)
		}
	}
	q = q.Arg("dir", dir)
