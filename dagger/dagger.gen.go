...
type Proxy = dagger.Proxy

type WithProxyFunc = dagger.WithProxyFunc
...
type ProxyOpts = dagger.ProxyOpts

type Result = dagger.Result

// ResultRunOpts contains options for Result.Run
type ResultRunOpts = dagger.ResultRunOpts
...
func (r *Voteapp) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Voteapp").
					WithFunction(
