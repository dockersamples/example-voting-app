...
type WithGoFunc = dagger.WithGoFunc

// GoBuildOpts contains options for Go.Build
type GoBuildOpts = dagger.GoBuildOpts

// GoExecOpts contains options for Go.Exec
type GoExecOpts = dagger.GoExecOpts

// GoWithBuildCacheOpts contains options for Go.WithBuildCache
type GoWithBuildCacheOpts = dagger.GoWithBuildCacheOpts

// GoWithEnvVariableOpts contains options for Go.WithEnvVariable
type GoWithEnvVariableOpts = dagger.GoWithEnvVariableOpts

// GoWithModuleCacheOpts contains options for Go.WithModuleCache
type GoWithModuleCacheOpts = dagger.GoWithModuleCacheOpts

type GoWithSource = dagger.GoWithSource

type WithGoWithSourceFunc = dagger.WithGoWithSourceFunc

// GoWithSourceBuildOpts contains options for GoWithSource.Build
type GoWithSourceBuildOpts = dagger.GoWithSourceBuildOpts

// GoWithSourceExecOpts contains options for GoWithSource.Exec
type GoWithSourceExecOpts = dagger.GoWithSourceExecOpts

// GoWithSourceWithBuildCacheOpts contains options for GoWithSource.WithBuildCache
type GoWithSourceWithBuildCacheOpts = dagger.GoWithSourceWithBuildCacheOpts

// GoWithSourceWithEnvVariableOpts contains options for GoWithSource.WithEnvVariable
type GoWithSourceWithEnvVariableOpts = dagger.GoWithSourceWithEnvVariableOpts

// GoWithSourceWithModuleCacheOpts contains options for GoWithSource.WithModuleCache
type GoWithSourceWithModuleCacheOpts = dagger.GoWithSourceWithModuleCacheOpts
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Result":
		...
		case "Run":
			...
			var componentsPath *Directory
			if inputArgs["componentsPath"] != nil {
				err = json.Unmarshal([]byte(inputArgs["componentsPath"]), &componentsPath)
				if err != nil {
